...
class StickerPackViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        addButton.setTitle("Zu Whatsapp hinzufügen", for: .normal)
        ...
        tapGuideLabel.text = "Viele viele Bunter Sticker"
    ...
    func showActionSheet(withSticker sticker: Sticker, overCell cell: UICollectionViewCell) {
        ...
        actionSheet.addAction(UIAlertAction(title: "Kopieren", style: .default, handler: { action in
            sticker.copyToPasteboardAsImage()
        }))
        actionSheet.addAction(UIAlertAction(title: "Teilen", style: .default, handler: { action in
            self.showShareSheet(withSticker: sticker)
        }))
        actionSheet.addAction(UIAlertAction(title: "HALT STOP JETZT REICHTS", style: .cancel, handler: nil))
    ...
    @objc func addButtonPressed(button: AquaButton) {
        let loadingAlert: UIAlertController = UIAlertController(title: "Nach Whatsapp übertragen...", message: "\n\n", preferredStyle: .alert)
